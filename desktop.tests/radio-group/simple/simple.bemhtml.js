...
function __$b5(__$ctx, __$ref) {
    var ctx__$31 = __$ctx.ctx, attrs__$32 = {
        type: "radio",
        autocomplete: "off",
        name: ctx__$31.name,
        value: ctx__$31.val
    };
    ctx__$31.checked && (attrs__$32.checked = "checked");
    ctx__$31.disabled && (attrs__$32.disabled = "disabled");
    return attrs__$32;
}
...
function __$b29(__$ctx, __$ref) {
    var ctx__$3 = __$ctx.ctx, mods__$4 = $$mods, buttonMods__$5 = {
    ...
    typeof ctx__$3.text !== "undefined" && buttonContent__$6.push({
        elem: "text",
...
function __$b39(__$ctx, __$ref) {
    var mods__$34 = $$mods, ctx__$35 = __$ctx.ctx;
    return (ctx__$35.options || []).map(function(option, i) {
        return [ !!i && !mods__$34.type && {
            tag: "br"
        }, {
            block: "radio",
            mods: {
                type: mods__$34.type,
                mode: mods__$34.mode,
                theme: mods__$34.theme,
                size: mods__$34.size,
                checked: option.checked,
                disabled: option.disabled || mods__$34.disabled
            },
            name: ctx__$35.name,
            val: option.val,
            text: option.text,
...
function __$g1(__$ctx, __$ref) {
    ...
    if (__$t === "radio-group") {
        ...
        if (!$$elem && $$mods && $$mods["type"] === "button" && (__$ctx.__$a0 & 2) === 0) {
